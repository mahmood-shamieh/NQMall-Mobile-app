            ...
            body: controller.loading.value
                ...
                : Stack(
                    children: [
                        ...
                        child: Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              MyText(
                                text:
                                    "${"ProductDetailsScreen.detailsTile".tr}:",
                                color: MyTheme.textColor,
                                fontWeight: FontWeight.w500,
                                size: MyTheme.textSizeLarge,
                              ),
                      ...
                      AnimatedScale(
                        scale:
                            controller.matchedVariation.value != null ? 1 : 0,
                        alignment: Alignment.bottomCenter,
                          ...
                          child: Container(
                            decoration: const BoxDecoration(
                              ...
                              borderRadius: BorderRadius.only(
                                ...
                                topRight:
                                    Radius.circular(MyTheme.buttonsRadius),
                              ),
                            ),
                            child: Padding(
                                ...
                                children: [
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      MyText(
                                        text: "ProductDetailsScreen.detailsTile"
                                            .tr,
                                        color: MyTheme.textColor,
                                        fontWeight: FontWeight.bold,
                                      ),
                                                ...
                                                ? Container(
                                                    ...
                                                    child: Column(
                                                      children: [
                                                        ...
                                                        MyButton(
                                                          height: 45,
                                                          text: ((getIt.get<CartModel>().CartItems ??
                                                                          [])
                                                                      .where((element) =>
                                                                          element
                                                                              .variationId ==
